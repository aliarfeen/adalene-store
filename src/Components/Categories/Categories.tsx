  ...
  const categories = [
    {
      ...
      category: "Handbags",
      description:
        "Stylish bags crafted for everyday elegance and practical storage solutions.",
    },
    {
      id: 2,
      name: "Belt",
      ...
      category: "Belts",
      description:
        "Premium leather belts designed to complete your look with sophistication.",
    },
    {
      id: 3,
      name: "Mini Bag",
      ...
      category: "Wallets",
      description:
        "Compact mini bags perfect for essentials while maintaining chic style.",
    },
    {
      id: 4,
      name: "Phone Case",
      ...
      description:
        "Protect your device with elegant cases that blend style and durability.",
    },
  ];
